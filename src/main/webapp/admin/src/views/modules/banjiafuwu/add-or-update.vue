<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搬家须知" prop="banjiaxuzhi">
          <el-input v-model="ruleForm.banjiaxuzhi" 
              placeholder="搬家须知" clearable  :readonly="ro.banjiaxuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搬家须知" prop="banjiaxuzhi">
              <el-input v-model="ruleForm.banjiaxuzhi" 
                placeholder="搬家须知" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="货车类型" prop="huocheleixing">
          <el-select v-model="ruleForm.huocheleixing" placeholder="请选择货车类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收费标准" prop="shoufeibiaozhun">
          <el-input v-model="ruleForm.shoufeibiaozhun" 
              placeholder="收费标准" clearable  :readonly="ro.shoufeibiaozhun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收费标准" prop="shoufeibiaozhun">
              <el-input v-model="ruleForm.shoufeibiaozhun" 
                placeholder="收费标准" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='banjiaxuzhi'){
            this.ruleForm.banjiaxuzhi = obj[o];
	    this.ro.banjiaxuzhi = true;
            continue;
          }
          if(o=='fuwuleixing'){
      ...
      this.$http({
		...
		if(json.sijidianhua!=''&&json.sijidianhua){
              		this.ruleForm.sijidianhua = json.sijidianhua
		}
		if(json.chepaihao!=''&&json.chepaihao){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/huocheleixing/huocheleixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.huocheleixingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `banjiafuwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.banjiafuwuCrossAddOrUpdateFlag = false;
                  this.parent.search();

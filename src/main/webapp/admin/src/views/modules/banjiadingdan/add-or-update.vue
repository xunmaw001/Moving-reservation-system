<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="司机账号" prop="sijizhanghao">
          <el-input v-model="ruleForm.sijizhanghao" 
              placeholder="司机账号" clearable  :readonly="ro.sijizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="司机账号" prop="sijizhanghao">
              <el-input v-model="ruleForm.sijizhanghao" 
                placeholder="司机账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="司机电话" prop="sijidianhua">
          <el-input v-model="ruleForm.sijidianhua" 
              placeholder="司机电话" clearable  :readonly="ro.sijidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="司机电话" prop="sijidianhua">
              <el-input v-model="ruleForm.sijidianhua" 
                placeholder="司机电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搬家人员" prop="banjiarenyuan">
          <el-input v-model="ruleForm.banjiarenyuan" 
              placeholder="搬家人员" clearable  :readonly="ro.banjiarenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搬家人员" prop="banjiarenyuan">
              <el-input v-model="ruleForm.banjiarenyuan" 
                placeholder="搬家人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家属电话" prop="jiashudianhua">
          <el-input v-model="ruleForm.jiashudianhua" 
              placeholder="家属电话" clearable  :readonly="ro.jiashudianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家属电话" prop="jiashudianhua">
              <el-input v-model="ruleForm.jiashudianhua" 
                placeholder="家属电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搬家价格" prop="banjiajiage">
          <el-input v-model="ruleForm.banjiajiage" 
              placeholder="搬家价格" clearable  :readonly="ro.banjiajiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搬家价格" prop="banjiajiage">
              <el-input v-model="ruleForm.banjiajiage" 
                placeholder="搬家价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="货车类型" prop="huocheleixing">
          <el-input v-model="ruleForm.huocheleixing" 
              placeholder="货车类型" clearable  :readonly="ro.huocheleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="货车类型" prop="huocheleixing">
              <el-input v-model="ruleForm.huocheleixing" 
                placeholder="货车类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搬家起点" prop="banjiaqidian">
          <el-input v-model="ruleForm.banjiaqidian" 
              placeholder="搬家起点" clearable  :readonly="ro.banjiaqidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搬家起点" prop="banjiaqidian">
              <el-input v-model="ruleForm.banjiaqidian" 
                placeholder="搬家起点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搬家目的地" prop="banjiamudedi">
          <el-input v-model="ruleForm.banjiamudedi" 
              placeholder="搬家目的地" clearable  :readonly="ro.banjiamudedi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搬家目的地" prop="banjiamudedi">
              <el-input v-model="ruleForm.banjiamudedi" 
                placeholder="搬家目的地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sijixingming = true;
          ...
          if(o=='sijidianhua'){
            this.ruleForm.sijidianhua = obj[o];
	    this.ro.sijidianhua = true;
            continue;
          }
          if(o=='chepaihao'){
	    ...
	    this.ro.chepaihao = true;
          ...
          if(o=='banjiarenyuan'){
            this.ruleForm.banjiarenyuan = obj[o];
	    this.ro.banjiarenyuan = true;
            continue;
          }
          if(o=='zhanghao'){
	    ...
	    this.ro.jiashudianhua = true;
          ...
          if(o=='banjiajiage'){
            this.ruleForm.banjiajiage = obj[o];
	    this.ro.banjiajiage = true;
            continue;
          }
          if(o=='fuwuleixing'){
	    ...
	    this.ro.yuyueshijian = true;
          ...
          if(o=='banjiaqidian'){
            this.ruleForm.banjiaqidian = obj[o];
	    this.ro.banjiaqidian = true;
            continue;
          }
          if(o=='banjiamudedi'){
            this.ruleForm.banjiamudedi = obj[o];
	    this.ro.banjiamudedi = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
		...
		if(json.jiashudianhua!=''&&json.jiashudianhua){
              		this.ruleForm.jiashudianhua = json.jiashudianhua
		}
        } else {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `banjiadingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.banjiadingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();

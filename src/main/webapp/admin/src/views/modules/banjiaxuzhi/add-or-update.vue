<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="搬家流程" prop="banjialiucheng">
          <el-input v-model="ruleForm.banjialiucheng" 
              placeholder="搬家流程" clearable  :readonly="ro.banjialiucheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="搬家流程" prop="banjialiucheng">
              <el-input v-model="ruleForm.banjialiucheng" 
                placeholder="搬家流程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shoufeibiaozhun = true;
          ...
          if(o=='banjialiucheng'){
            this.ruleForm.banjialiucheng = obj[o];
	    this.ro.banjialiucheng = true;
            continue;
          }
          if(o=='xiangqing'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm5rbk6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `banjiaxuzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.banjiaxuzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();

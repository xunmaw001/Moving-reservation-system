<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="驾龄" prop="jialing">
          <el-input v-model="ruleForm.jialing" 
              placeholder="驾龄" clearable  :readonly="ro.jialing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="驾龄" prop="jialing">
              <el-input v-model="ruleForm.jialing" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='jialing'){
            this.ruleForm.jialing = obj[o];
	    this.ro.jialing = true;
            continue;
          }
          if(o=='chepaihao'){
